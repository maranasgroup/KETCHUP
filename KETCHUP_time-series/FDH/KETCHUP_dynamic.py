...
def ketchup_model_options() -> dict:
    ...
    model_options = {
        ...
        #'directory_data' : f"./",
        'filename_data' : 'FDH_dataset_series_B1.xlsx',
        #'filename_data' : 'FDH_data_from_Schmidt.xlsx',
    ...
    model_options['mechanism_type'] = 'custom' # rate law to follow
...
def main() -> None:
    ...
    if 'Olson02' in ketchup_options['directory_output']: ketchup_model.K_decomp.bounds = (0.0001496111451844639,0.00034939142773492696)
    if 'Olson03' in ketchup_options['directory_output']: ketchup_model.K_decomp.bounds = (0.00011180117533080114, 0.00017663882226506383)
...
#    infeasible_constraints(ketchup_model, 'infeasibility.txt', tol=10**-7)
    return
    # end of main
